 ...
 function epkb_archive_header( $args ) {
	/// $category_archive_title_icon    = 'epkbfa epkbfa-folder-open';
	 ...
	 <div class="breadcrumb">
			<ul>
				<li><a href="<?php echo site_url();?>/how-to"><?php if(ICL_LANGUAGE_CODE=='en'){ echo 'How-to'; } 
...
<div class="search" id="search-category">
	<?php echo do_shortcode('[ivory-search id="597" title="ajax_archive"]'); ?>
                            <!-- <form class="search-form wow slideInUp">
                                <input class="form-control search_input" type="text" placeholder="Search in <?php ///echo esc_html($category_title); ?>  articles">
...
function epkb_main_content( $args ) {
	...
	<main class="eckb-category-archive-main <?php esc_attr_e($preset_style); ?> tt">   <?php
			...
			<article class="eckb-article-container" id="post-<?php the_ID(); ?>">
				<div class="row">
					...
					<div class="col-lg-6 cstm-blog-details-col">
						...
						<h4>Edited <?php echo get_the_date();?></h4>
						<p><?php $content = get_the_content();$content = strip_tags($content);echo substr($content, 0, 320);?>...</p>
					</div>	
